  ...
  <div class="nav-tabs-custom">
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane" id="tab_4">
        @foreach($children_files as $file)
          <div class="downloadListBox">
            <div class="row">
              <div class="hidden-xs col-sm-2 col-md-2 dIcon">
                {{DownloadHelper::getFileIcon($file['mime_type'])}}
      ...
      {{--<div class="tab-pane @if(isset($init_tab) && $init_tab=='upload') active @endif" id="tab_5">
        @include('download-manager.views.frontend.fileupload')
      </div>--}}
