  ...
  <body>
    <div class="content"> 
      ...
      <div class="row">
        <div class="col-sm-6">
          @if(count($data))
          <form action = "{{URL::route('teacher-cas-sub-topics-create-edit-post', $subject_id)}}" method = "post">
            ...
            <div id = "ajax-content">
              <div class = "dynamic_content">
                <div class="form-group">
                  ...
                  <input id="topic_name" class="form-control" type="text" name = "topic_name[]" placeholder="e.g. Reading, Writing" required>
                </div>

                <div class="form-group">
                  <label for="topic_name">Topic Description</label>
                  <textarea id="topic_description" class="form-control" name = "topic_description[]" required></textarea>
                </div>
    ...
    <script>
      $(function()
      {
        ...
        {
          e.preventDefault();
          $('tbody').append('<tr><td></td><td class = "input-data-topic-name"><input type = "text" name = "topic_name[]"></td><td class = "input-data-topic-description"><input type = "text" name = "topic_description[]"</td><td class = "actions"><a href = "#" class = "btn btn-danger btn-flat dynamic-row-remove"> Remove </a></td><input type = "hidden" name = "id[]" value = "0"></tr>');
