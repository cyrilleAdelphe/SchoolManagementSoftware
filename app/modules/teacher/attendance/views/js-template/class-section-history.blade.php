                        ...
                        <table id="fileList" class="table table-bordered table-striped">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>{{$d['late_days']}}</td>
                              <td>
                                <a href="{{URL::route('attendance-view-student-get')}}?student_id={{$d['student_id']}}&date_range={{$date_range}}" data-toggle="tooltip" title="View Detail" class="btn btn-info btn-flat">
