<div id="delete_transportation_student{{$d->id}}" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          <form action="{{URL::route('transportation-student-delete-single-post',$d->id)}}" method="post">
