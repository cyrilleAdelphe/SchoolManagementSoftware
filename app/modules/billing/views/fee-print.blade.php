...
@section('tab-content')
            ...
            <form method="GET" action="{{URL::route('billing-fee-print-list')}}">
              <div class="row">
              ...
              <input type = "hidden" id = 'billing-ajax-get-student-select-list' value = '{{URL::route('billing-ajax-get-student-select-list-fee-print')}}'>
              </form>  
@stop
