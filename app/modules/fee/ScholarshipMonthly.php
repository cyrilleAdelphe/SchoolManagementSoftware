...
class ScholarshipMonthly extends BaseModel
{
	protected $table = 'fee_scholarship_monthly';
	...
	public $createRule = [
							...
							'scholarship_id' => array('required', 'exists:fee_scholarship,id')
						];
	...
	public $updateRule = [
							...
							'scholarship_id' => array('exists:fee_scholarship,id')
						];
