...
class MonthlyStudentFee extends BaseModel
{
	protected $table = 'fee_monthly_student';
	...
	public $createRule = [
							...
							'fee_monthly_id' => array('required', 'exists:fee_monthly,id')
						];
	...
	public $updateRule = [
							...
							'fee_monthly_id' => array('exists:fee_monthly,id')
						];
