	...
	<!-- Main content -->
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
              ...
              <li {{ $init_tab == 'app_data' ? 'class="active"' : ''}}><a href="#tab_7" data-toggle="tab">App Data</a></li>
          </ul>
          <div class="tab-content">
            ...
            <div class="{{ $init_tab == 'list_article' ? 'tab-pane active' : 'tab-pane' }}"
              ...
              <div class="{{ $init_tab == 'app_data' ? 'tab-pane active' : 'tab-pane' }}"
                  id="tab_7">
                @include('articles.views.app-data-create')
              </div>
...
@section('custom-js')
	...
	<script>
			...
			{
				var roxyFileman = "{{VENDOR_PATH}}text-editor/fileman/index.html?integration=ckeditor";
				$(function()
				{
