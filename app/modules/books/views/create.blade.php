...
@section('content')
    ...
    <div class="form-group @if($errors->has("title")) {{"has-error"}} @endif">
      ...
      <input id="title" name="title" class="form-control" type="text" placeholder="Enter title" value="{{Input::old('title')?Input::old('title'):''}}">
      <span class = 'help-block'>@if($errors->has('title')) {{$errors->first('title')}} @endif</span>
    </div>
    <div class="form-group @if($errors->has("category_id")) {{"has-error"}} @endif">
      <label>Choose Category</label>
      {{HelperController::generateStaticSelectList($categories, 'category_id', Input::old('category_id'))}}
    ...
    <div class="form-group @if($errors->has("author")) {{"has-error"}} @endif">
      ...
      <input id="author" name="author" class="form-control" type="text" placeholder="Written by" value="{{Input::old('author')?Input::old('author'):''}}">
    ...
    <div class="form-group @if($errors->has("published_date")) {{"has-error"}} @endif">
      ...
      <div class="input-group">
        ...
        <input type="text" name="published_date" class="form-control" placeholder='Enter published date' data-inputmask="'alias': 'yyyy-mm-dd'" data-mask value="{{Input::old('published_date')?Input::old('published_date'):''}}"/>
        <span class = 'help-block'>@if($errors->has('published_date')) {{$errors->first('published_date')}} @endif</span>
      </div>
    </div>
    <div class="form-group @if($errors->has("price")) {{"has-error"}} @endif">
      <label for="price">Price</label>
      <input id="price" name="price" class="form-control" type="text" placeholder="Enter book price" value="{{Input::old('price')?Input::old('price'):''}}">
    ...
    <div class="form-group @if($errors->has("book_ids")) {{"has-error"}} @endif">
      ...
      <input name="book_ids" data-toggle="tooltip" title="You can enter multiple ID by seperating with , sign or define range with - sign." id="range" class="form-control" type="text" placeholder="Enter book number/range" value="{{Input::old('book_ids')?Input::old('book_ids'):''}}">
    ...
    <div class="form-group @if($errors->has("max_holding_days")) {{"has-error"}} @endif">
      ...
      <input id="total" name="max_holding_days" class="form-control" type="text" placeholder="Enter numnber of days" value="{{Input::old('max_holding_days')?Input::old('max_holding_days'):''}}">
    ...
    <div class="form-group">
      <button class="btn btn-success submit-enable-disable" type="submit" related-form='backendForm'>Save and Close</button>
      <button class="btn btn-primary submit-enable-disable" type="submit" related-form='backendForm'>Save and New</button>
    </div>
