...
@section('tab-content')
  <div class = "row">
    <b>{{Input::get('sender_name')}}</b> Contact List
  </div>
  ...
  <div id = "message_list" class = "content">                            
    @include('staff-request.views.ajax.staff-contact-list')
  </div>
    ...
    <script type="text/javascript">
      $(function() {
          ...
          function ajaxRequest(page)
          {
            ...
            $.ajax({
                "url": "{{URL::route('staff-request-ajax-staff-contact-list', array($staff_group, $staff_id))}}",
                "data": {
