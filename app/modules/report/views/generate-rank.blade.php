...
<div class="nav-tabs-custom">
  <ul class="nav nav-tabs">
    <li><a href="#tab_1" data-toggle="tab">Generate Rank</a></li>
    <li><a href="{{URL::route('report-list')}}">Report List</a></li>
  </ul>
  <div class="tab-content">
    <div class="tab-pane active" id="tab_1">
      <form method = "post" action = "{{URL::route('report-generate-rank-post')}}">
      <div class="row">
          <div class="col-sm-3">
      ...
      <div class="row">
        <div class="col-sm-3">
          <button type = "submit" class="btn btn-block btn-success btn-lg" @if(!AccessController::checkPermission('report', 'can_config')) disabled @endif>
            <i class="fa fa-fw fa-bar-chart" ></i> Generate Rank
          </button>
        </div>
      </div>   
      {{Form::token()}}
