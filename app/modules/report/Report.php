...
class Report extends BaseModel
{
	...
	public function getListViewData($queryString)
	{
		...
		if($class_id && $section_id && $exam_id)
		{
			...
			$last_updated_data = Report::getLastUpdated($condition = array(array('field_name' => 'is_active', 'operator' => '=', 'compare_value' => 'yes')), $fields_required = array('updated_by', 'id'), 'Report');
