...
@section('content')
  ...
  <section class="content">
    <div class="box">
        <div class="box-body">
        	@define $input_value = [];
			    @define $fields = ['title','information','is_active'];
			    @foreach($fields as $field)
			      @define $input_value[$field] = Input::old($field) ? Input::old($field) : $item[$field];
			    @endforeach

			   
        	<form method="post" action = "{{ URL::route('list-edit-post') }}" enctype="multipart/form-data">
              ...
              <div class="form-group">
	              <label for="profilePic">Upload New Icon</label>
