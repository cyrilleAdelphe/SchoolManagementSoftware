                            ...
                            <table id="pageList" class="table table-bordered table-striped">
                              ...
                              @foreach($data as $d)
                                <tr>
                                  ...
                                  <td>
                                    <a data-toggle="tooltip" title="View" class="btn btn-info btn-flat" href="{{URL::route('message-staff-contact-list', array($d->message_from_group, $d->message_from_id))}}?sender_name={{urlencode($d->name)}}&sender_username={{urlencode($d->username)}}">
