<div id="find-id2" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="modal-footer">
          <button type="button"A class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
      </div>
    </div>
  </div>
...
$('#group_id').change(function()
{
  ...
  $('#find_result2').html('<div class="dloading"><img src="{{ asset('sms/assets/img/loading.gif') }}"><br/>loading...</div>');
  $.ajax({
            "url" : "{{URL::route('ajax-get-modal-employee-search-list')}}",
            "data" : {'group_id' : group_id},
            "method" : "GET"
        } ).done(function(data) {
          $('#find_result2').html(data);
  });
});
