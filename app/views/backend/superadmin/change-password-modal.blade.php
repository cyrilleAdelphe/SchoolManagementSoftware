...
<div id="change-password" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form method="POST" action="{{ URL::route('superadmin-change-details-post', Auth::superadmin()->user()->id) }}" enctype = "multipart/form-data">
      	<div class="modal-body">
      		<div class="form-group">
            <input name="name" id="fullname" class="form-control" type="text" placeholder="Name" value="{{ Auth::superadmin()->user()->name }}" />
          </div>
      	  <div class="form-group">
          ...
          <!-- <div class = 'form-group'>
						...
						@if (File::exists(app_path(). '/modules/superadmin/assets/images/'. Auth::superadmin()->user()->id))
							<img src = "{{Config::get('app.url').'app/modules/superadmin/assets/images/'. Auth::superadmin()->user()->id}}" width="250px" height="auto">
						@else
