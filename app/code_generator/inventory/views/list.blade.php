		...
		@if($arr['count'])
			<?php $i = 1; ?>
				<tr>
					...
					<td><input type = 'text' class = 'search_column'  id = '3'><input type = 'hidden' class = 'field_name' value = 'inventory_price'></td>
					<td><input type = 'text' class = 'search_column'  id = '4'><input type = 'hidden' class = 'field_name' value = 'inventory_stock'></td>
